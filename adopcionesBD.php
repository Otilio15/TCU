    ...
    if (isset($_POST['update'])){
      ...
      if ($Foto == ""){
        ...
        if(isset($_GET['del'])){
            ...
            $sql= "SELECT id13721146_pawlog.animales.*, TIMESTAMPDIFF(YEAR,Edad,CURDATE()) AS EdadActual, id13721146_pawlog.adopciones.IdAnimal AS IdAnimalAdopciones 
            FROM id13721146_pawlog.animales LEFT OUTER JOIN id13721146_pawlog.adopciones ON id13721146_pawlog.animales.IdAnimal = id13721146_pawlog.adopciones.IdAnimal
            WHERE (id13721146_pawlog.adopciones.IdAnimal IS NULL)";
